...
--
-- Table structure for table `ordered_procedures`
--

DROP TABLE IF EXISTS `ordered_procedures`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ordered_procedures` (
  `mrn` int(11) NOT NULL,
  `enroll_start_dt` int(11) DEFAULT NULL,
  `enroll_end_dt` int(11) DEFAULT NULL,
  `enroll_status` varchar(32) DEFAULT NULL,
  `order_time` int(11) DEFAULT NULL,
  `result_time` int(11) DEFAULT NULL,
  `proc_start_time` int(11) DEFAULT NULL,
  `proc_ending_time` int(11) DEFAULT NULL,
  `description` varchar(60) DEFAULT NULL,
  `order_type` varchar(19) DEFAULT NULL,
