...
CREATE TABLE `INPUTEVENTS_CV` (
  ...
  `AMOUNTUOM` varchar(255) DEFAULT NULL,
  ...
  `NEWBOTTLE` tinyint(3) unsigned DEFAULT NULL,
  `ORIGINALAMOUNT` float DEFAULT NULL,
  `ORIGINALAMOUNTUOM` varchar(255) DEFAULT NULL,
  `ORIGINALROUTE` varchar(255) DEFAULT NULL,
  `ORIGINALRATE` float DEFAULT NULL,
  `ORIGINALRATEUOM` varchar(255) DEFAULT NULL,
  `ORIGINALSITE` varchar(255) DEFAULT NULL,
  UNIQUE KEY `INPUTEVENTS_CV_ROW_ID` (`ROW_ID`),
